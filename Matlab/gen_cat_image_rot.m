...
for i = 0:N
    ...
    % compute the small angle (±(i mod 11) degrees)
    % The rotation angle is 0°, ±1°, ±2°, ..., ±10°, in alternating directions
    angle = (-1)^i * mod(i,11);
    ...
    % creates a path like '../synthetic_data/cat_image_rot/cat_001.mat'
    fnameMAT = fullfile(folderMAT, [name '.mat']);
    save(fnameMAT, 'A');

    % creates PNG in path like '../synthetic_data/cat_image_rot/png/cat_001.png'
