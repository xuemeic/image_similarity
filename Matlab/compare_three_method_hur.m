...
function result = compare_three_method_hur(K, topJ, seed)
...
%   .overlap_all3_indices,   .overlap_all3_count
    ...
    folder = '/Users/lanheng/Desktop/image_similarity_2025/image_similarity/synthetic_data/cat_image';
    ...
    for i = 1:N
        S = load(fullfile(folder, sprintf('cat_%03d.mat', i)));
        image_collection(:, :, i) = S.A;   % each MAT has mxn variable A
    end
